...
const columns = [
  { field: "cmid", headerName: "ID", flex: 0.4, headerClassName: "bold-header", disableColumnMenu: false, minWidth: 100 },
  { field: "cmname", headerName: "Name", flex: 2, headerClassName: "bold-header", disableColumnMenu: true, minWidth: 200 },
  { field: "organizationid", headerName: "Organization ID", flex: 1, headerClassName: "bold-header", disableColumnMenu: true, minWidth: 150 },
  { field: "organizationname", headerName: "Organization Name", flex: 1, headerClassName: "bold-header", disableColumnMenu: true, minWidth: 150 },
  { field: "branch", headerName: "Branch", flex: 1, headerClassName: "bold-header", disableColumnMenu: true, minWidth: 150 },
  ...
  useEffect(() => {
    const fetchRelations = async () => {
      try {
        ...
        const response = await fetch(`http://localhost:8080/api/v1/getRelationByCrmId/${userDetails.crmid}`);
